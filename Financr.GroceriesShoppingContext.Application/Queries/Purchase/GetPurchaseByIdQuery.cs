...
public sealed record GetPurchaseByIdQuery(Guid PurchaseId) : ICommand<Result<GetPurchaseByIdQueryResponse, CommandErrorValidation>>, IValidator<CommandErrorValidation>
{
